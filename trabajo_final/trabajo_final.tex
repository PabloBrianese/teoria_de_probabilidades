...
\end{corollary}
\begin{proof}
  Basta con recordar que los procesos constantes son progresivamente medibles, ver el pasado corolario \ref{corollary:windowedIntegralOfProgressivelyMeasurableProcess}, y usar el teorema \ref{theorem:algebraOfProgressiveProcesses} diciendo que el producto de procesos progresivamente medibles es otro de ellos.
\end{proof}
