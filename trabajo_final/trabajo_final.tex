...
\begin{proof}
  ...
  En segundo lugar, \(E \setminus A \in \progressiveAlgebra\) siempre que \(A \in \progressiveAlgebra\).
  Esto se debe a que, para cada \(t \geq 0\), la función \(\restrict{\characteristic_{E \setminus A}}{E_t}\) es 0 sobre el conjunto \(A \cap E_t\) e igual a 1 sobre el conjunto \((E \setminus A) \cap E_t\), ambos apropiadamente medibles.
