...
Para ser precisos escribimos \(\prob_k = \prob(\;\cdot\; | X_0 = k) = \prob(\;\cdot\; | Y_0 = k)\) y similar para los demás estados.
Así
\begin{align}
	&\prob_k(Y_M = i + 1) 
	\\
...
\end{align}
Expresada en términos de la matriz de transición de probabilidad \(\Pi = (p_{a b})_{a,b \in \stateSpace}\), esta igualdad se lee
\begin{align}
	\prob_k(Y_M = i + 1)
	&=
		p_{k, k - 1} p_{k - 1, k - 2} \cdots p_{i + 1, 1} \times p_{i, i + 1}
		\\
	&= 
